...
class BaseConfig:
    ...
    MAIL_DEFAULT_SENDER = os.environ.get("MAIL_DEFAULT_SENDER") or "info@baimuras.space"
    ...
    N8N_API_URL = os.environ.get("N8N_API_URL") or "http://localhost:5678/api/v1"
    ...
    RATELIMIT_STORAGE_URL = (
        os.environ.get("RATELIMIT_STORAGE_URL") or "redis://localhost:6379/1"
    )
...
class DevelopmentConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        ...
        os.path.dirname(os.path.dirname(__file__)), "instance", "baimuras_dev.db"
    )
...
class StagingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = (
        ...
        or "postgresql://localhost/baimuras_staging"
    )
...
class ProductionConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = (
        ...
        or "postgresql://localhost/baimuras_production"
    )
...
class DockerConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = (
        os.environ.get("DATABASE_URL")
        or "postgresql://postgres:password@db:5432/baimuras"
    )
    ...
    RATELIMIT_STORAGE_URL = (
        os.environ.get("RATELIMIT_STORAGE_URL") or "redis://redis:6379/1"
    )
