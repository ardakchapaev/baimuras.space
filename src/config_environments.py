...
class DevelopmentConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URL') or \
        'sqlite:///' + os.path.join(os.path.dirname(os.path.dirname(__file__)), 'instance', 'baimuras_dev.db')
...
class StagingConfig(BaseConfig):
    ...
    # CORS для staging
    CORS_ORIGINS = ['https://staging.baimuras.space', 'https://hub-staging.baimuras.space']
