...
class JWTManager:
    ...
    def init_app(self, app):
        ...
        app.config.setdefault('JWT_SECRET_KEY', os.environ.get('JWT_SECRET_KEY', 'your-secret-key'))
...
def generate_tokens(user_id: int, user_email: str, user_role: str = 'user') -> Dict[str, str]:
    """
