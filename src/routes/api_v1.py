...
from ..models import db, User, Lead, Project, ConsultationRequest, Role
from ..utils.jwt_utils import (
    generate_tokens, refresh_access_token, jwt_required, 
    admin_required, manager_required, optional_jwt, get_current_user
)
from ..utils.n8n import send_lead_to_automation, send_consultation_to_automation, send_project_update_to_automation
from ..automation.tasks.email_tasks import send_welcome_email, send_lead_notification
from ..automation.tasks.notification_tasks import process_notification
...
def create_lead():
    ...
    try:
        ...
        manager_emails = ['manager@baimuras.space']  # TODO: Получить из настроек
