...
def get_consultations():
    ...
    try:
        ...
        return (
            jsonify(get_consultation_error_response("Error fetching consultations")),
            500,
        )
...
def get_consultation(consultation_id):
    ...
    try:
        ...
        return jsonify({"success": True, "data": consultation.to_dict()}), 200
    except Exception:
...
def update_consultation(consultation_id):
    ...
    try:
        ...
        db.session.rollback()
        return (
            jsonify(get_consultation_error_response("Error updating consultation")),
            500,
        )
...
def get_projects():
    ...
    try:
        ...
        return (
            jsonify(
                {"success": True, "data": [project.to_dict() for project in projects]}
            ),
            200,
        )
    except Exception:
...
def get_leads():
    ...
    try:
        ...
        return (
            jsonify({"success": True, "data": [lead.to_dict() for lead in leads]}),
            200,
        )
    except Exception:
...
def create_lead():
    ...
    try:
        ...
        if not data.get("name") or not data.get("contact"):
            return (
                jsonify(
                    get_consultation_error_response("Name and contact are required")
                ),
                400,
            )
