...
from src.content import CONTACT_FORM, HOMEPAGE, SERVICES
...
def services_children_rooms():
    ...
    return render_template(
        "services_children_rooms.html", service=content["children_rooms"]
    )
...
def contact():
    ...
    if request.method == "POST":
        try:
            ...
            app.logger.error(f"Error saving consultation request: {consultation_error}")
...
def services_custom_furniture():
    ...
    return render_template(
        ...
        service=content.get("custom_furniture", content["montessori"]),
    )
...
def services_design_bureau():
    ...
    return render_template(
        ...
        service=content.get("design_bureau", content["kitchens"]),
    )
...
def services_academy():
    ...
    content = SERVICES.get(current_lang, SERVICES["ru"])
    return render_template(
        "services_academy.html", service=content.get("academy", content["montessori"])
    )
